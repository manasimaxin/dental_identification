...
# Load dataset from caries detection folder
data_dir = "/Users/manasimaxin/Downloads/caries detection/general_classification"
...
if __name__ == '__main__':
    # Training loop with increased epochs for larger dataset
    num_epochs = 10
